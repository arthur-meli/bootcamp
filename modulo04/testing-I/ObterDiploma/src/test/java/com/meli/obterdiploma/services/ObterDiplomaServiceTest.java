...
public class ObterDiplomaServiceTest {
    ...
    public void shouldAnalyzeScores() {
        ...
        StudentDTO student = StudentDTO.builder().id(1L).studentName("arthur").subjects(Arrays.asList(subject1, subject2)).build();
...
//        }
    ...
    public void shouldGenerateGreetingMessageCongratulations() {
        ...
        Assertions.assertEquals("O aluno arthur obteve uma média de 10. Parabéns!", response.getMessage());
    }
    ...
    public void shouldGenerateGreetingMessageCanBeBetter() {
        ...
        Assertions.assertEquals("O aluno arthur obteve uma média de 5,5. Você pode melhorar.", response.getMessage());
    }
}